...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <link href="https://fonts.bunny.net/css?family=Inter:ital,wght@0,300;0,400;0,500;0,600;0,700;0,800;1,900&display=swap" rel="stylesheet" />
        <link href="https://fonts.bunny.net/css?family=JetBrains+Mono:ital,wght@0,100..800&display=swap" rel="stylesheet" />

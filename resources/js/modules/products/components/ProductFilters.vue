...
const statusOptions = computed(() => [
    { value: '', label: t('products.filters.all_statuses') },
...
const stockStatusOptions = computed(() => [
    { value: '', label: t('products.filters.all_stock') || 'All Stock' },
    { value: 'in_stock', label: t('products.stock.status.in_stock') },
    { value: 'low', label: t('products.stock.status.low_stock') },
    { value: 'out', label: t('products.stock.status.out_of_stock') }
]);
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <div>
                    ...
                    <select
                        ...
                        class="block w-full rounded-lg border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500 px-3 py-2"
                    >
                        <option value="">{{ t('products.filters.all_products') || 'All' }}</option>
                        <option value="1">{{ t('products.filters.featured_only') || 'Featured Only' }}</option>
                        <option value="0">{{ t('products.filters.not_featured') || 'Not Featured' }}</option>
                    </select>
                </div>
            </div>
